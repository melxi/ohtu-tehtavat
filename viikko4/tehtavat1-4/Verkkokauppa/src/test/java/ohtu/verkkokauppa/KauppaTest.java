...
public class KauppaTest {
    ...
    public void setUp() {
        ...
        when(varasto.haeTuote(3)).thenReturn(new Tuote(3, "tee", 2));
    ...
    @Test
    public void ostoksenPaatyttyaPankinMetodiaTilisiirtoKutsutaanOikeillaTiedoilla() {
        k.aloitaAsiointi();
        k.lisaaKoriin(1);
        k.tilimaksu("pekka", "12345");
    ...
    @Test
    public void loppuneenTuotteenOstoksenPaatyttyaPankinMetodiaTilisiirtoKutsutaan() {
        k.aloitaAsiointi();
        k.lisaaKoriin(1);
        k.lisaaKoriin(3);
        k.tilimaksu("pekka", "12345");
    ...
    @Test
    public void kaupanMetodiAloitaAsiointiNollaaOstoksenTiedot() {
        k.aloitaAsiointi();
        k.lisaaKoriin(1);
        k.aloitaAsiointi();
        k.tilimaksu("pekka", "12345");
    ...
    @Test
    public void ostoksenLisattyaKaupanMetodiPoistaKoristaOstoksen() {
        k.aloitaAsiointi();
        k.lisaaKoriin(1);
